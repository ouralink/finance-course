...
import { Search, Bell, User, Menu, X, BookOpen, TrendingUp, GraduationCap } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm">
      <div className="flex items-center justify-between px-4 py-3 lg:px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-sm text-gray-500 font-medium">Ivy League Standard</p>
            </div>
          </Link>
        </div>
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full group">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all duration-200 text-sm placeholder-gray-500"
            />
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* User profile */}
          <div className="flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl px-3 py-2 hover:from-blue-100 hover:to-indigo-100 transition-all duration-200 cursor-pointer group">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-200">
